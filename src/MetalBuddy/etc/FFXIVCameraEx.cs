...
namespace MetalBuddy.etc
{
    ...
    public static class FF14Camera
    {
        ...
        public static SlimDX.Vector3 CameraLocation => Core.Memory.Read<SlimDX.Vector3>(CameraManager.CameraLocationPtr);

        public static SlimDX.Vector3 Up = new SlimDX.Vector3(0, 1, 0);
