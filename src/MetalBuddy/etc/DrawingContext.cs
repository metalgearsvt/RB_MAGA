...
namespace MetalBuddy.etc
{
    public class DrawingContext : IDisposable, I3DDrawer
    {
        ...
        public void DrawText(string text, int x, int y, Color color, float emSize = 10f,
            FontStyle fontStyle = FontStyle.Regular, bool begin = true)
        {
            ...
            Rectangle rect = new Rectangle(x, y, stringRect.Width*10, stringRect.Height + 20);
        ...
        public void DrawOutlinedText(string text, int x, int y, Color color, Color shadowColor,
            float emSize = 10f, FontStyle fontStyle = FontStyle.Regular)
        {
            if (_fontSprite == null)
            {
                _fontSprite = new Sprite(Device);
